...
class Course extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, schoolid, coursename, studyarea, price1, price2, description', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('studyarea',$this->studyarea,true);
