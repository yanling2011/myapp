...
class YiiBase
{
	...
	private static $_coreClasses=array(
		...
		//SAE ASSETS 鐗规畩澶勭悊
		'SAEFileHelper' => '/sae/SAEFileHelper.php',
		'SAEAssetManager' => '/sae/SAEAssetManager.php',
		'SAEAssetsAction' => '/sae/SAEAssetsAction.php',
		//SAE MEMCACHE 缂撳瓨
		'SAEMemCache' => '/sae/SAEMemCache.php',
		//SAE debug
		'SAELogRoute' => '/sae/SAELogRoute.php',
		//SAE 璇诲啓鍒嗙
		'SAEDbConnection' => '/sae/SAEDbConnection.php',
		
		'CDbCommand' => '/sae/CDbCommand.php',
		'CStatePersister' => '/sae/CStatePersister.php',
	);
}
